...
from heat_anomaly.utils.callbacks import (
...
from heat_anomaly.utils.loggers import configure_logger
...
class AnomalibCLI(LightningCLI):
    ...
    def __set_callbacks(self) -> None:
        ...
        if config.export_mode is not None:
            from heat_anomaly.utils.callbacks.export import (  # pylint: disable=import-outside-toplevel
                ExportCallback,
            )
